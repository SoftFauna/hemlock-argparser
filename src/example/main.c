...
main (int argc, char **argv)
{
    ...
    const copt_t OPTS[] =
    {
        ...
        { 'h', "--help",    CALLBACK,  { .cb_fn = usage_cb },   "show this page." },
        ...
        {  0, "--this-is-too-long-to-be-reasonable",      FLAG_T, { &too_long_a}, "log extra messages." },
        {  0, "--this-is-also-too-long-to-be-reasonable", FLAG_T, { &too_long_b}, "log extra messages and do about 999999999999999999999999 other things but we dont care about any of them, we are just looking for a really long line to test how wrapping text works with the parser." },
        {  0, "---reasonable",                            FLAG_T, { &reasonable}, "log extra messages and do about 999999999999999999999999 other things but we dont care about any of them, we are just looking for a really long line to test how wrapping text works with the parser." },
    };
